...
function WeaponUnderbarrelLauncher:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, shoot_through_data)
	self._ammo_data = {
		launcher_grenade = self.launcher_projectile
	}
	local unit
	local spread_x, spread_y = 0, 0
