...
function TangoTweakData:init(tweak_data)
	...
	table.insert(self.challenges, {
		...
		rewards = {
			...
			{item_entry = "facepaint", type_items = "textures"},
	...
	table.insert(self.challenges, {
		...
		rewards = {
			...
			{item_entry = "sight", type_items = "textures"},
			{tango_weapon_part = true}
		}
	})
	table.insert(self.challenges, {
		...
		rewards = {
			...
			{item_entry = "bullets", type_items = "textures"},
			{tango_weapon_part = true}
		}
	})
	table.insert(self.challenges, {
		...
		reward_type = "tango",
		rewards = {
			{item_entry = "tng_cap", type_items = "masks"},
			{
				item_entry = "midnight_camo",
				type_items = "materials"
			},
			{item_entry = "stripes", type_items = "textures"},
			{tango_weapon_part = true}
		}
	})
end
