...
function Drill:set_skill_upgrades(upgrades)
	...
	if self.is_drill or self.is_saw then
		...
		if upgrades.speed_upgrade_level and 2 <= upgrades.speed_upgrade_level or current_speed_upgrade >= 2 then
		...
		elseif upgrades.speed_upgrade_level and 1 <= upgrades.speed_upgrade_level or current_speed_upgrade >= 1 then
