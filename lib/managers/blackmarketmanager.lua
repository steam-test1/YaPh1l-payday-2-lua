...
function BlackMarketManager:henchman_loadout(index)
	...
	return self._global._selected_henchmen[index]
end
...
function BlackMarketManager:is_weapon_allowed_for_crew(weapon_id)
	...
	return data and self:is_weapon_category_allowed_for_crew(data.category) or false
end
