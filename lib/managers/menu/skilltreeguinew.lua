...
function NewSkillTreeGui:_setup()
	...
	local color = 0 < self._skilltree:points() and tweak_data.screen_colors.text or tweak_data.screen_colors.important_1
...
function NewSkillTreeGui:_update_rename_skill_switch()
	...
	if self._renaming_skill_switch then
		...
		self._rename_caret:set_position(skill_set_text:right(), skill_set_text:top())
	else
