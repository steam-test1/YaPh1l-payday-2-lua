...
function VehicleFactoryTweakData:_init_muscle_2()
	...
	self.vhc_fps_muscle_2.unit = "units/pd2_dlc_drive/vehicles/fps_vehicle_muscle_2/fps_vehicle_muscle_2"
	self.vhc_fps_muscle_2.dummy_unit = "units/pd2_dlc_drive/vehicles/fps_vehicle_muscle_2/fps_vehicle_muscle_2_dummy"
	self.vhc_fps_muscle_2.texture_bundle_folder = "greasy"
	self.vhc_fps_muscle_2.default_blueprint = {
	...
	self.vhc_fps_muscle_2.uses_parts = {
		"vhc_fps_muscle_bf_mod0",
