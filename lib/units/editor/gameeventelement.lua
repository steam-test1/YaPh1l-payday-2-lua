...
function GameEventElement:_build_panel(panel, panel_sizer)
	...
	input_category:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = input_category, value = "category"})
	input_category:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = input_category, value = "category"})
	input_event:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = input_event, value = "event"})
	input_event:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = input_event, value = "event"})
