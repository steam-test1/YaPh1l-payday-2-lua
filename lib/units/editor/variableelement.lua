...
function VariableElement:_build_panel(panel, panel_sizer)
	...
	input:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = input, value = "variable"})
	input:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = input, value = "variable"})
