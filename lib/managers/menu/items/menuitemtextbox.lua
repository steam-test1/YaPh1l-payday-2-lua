...
function MenuItemTextBox:_ctrl()
	...
	return not k:down(Idstring("left ctrl")) and not k:down(Idstring("right ctrl")) and k:has_button(Idstring("ctrl")) and k:down(Idstring("ctrl"))
end
...
function MenuItemTextBox:find_first_non_letter(str)
	...
	return string.find(latin_str, utf8.to_latin1("[^A-Za-z0-9\195\133\195\132\195\150\195\165\195\164\195\182\195\129\195\137\195\147\195\154\195\141\195\157\195\161\195\169\195\179\195\186\195\173\195\189\195\130\195\138\195\155\195\142\195\148\195\162\195\170\195\187\195\174\195\180\195\131\195\149\195\145\195\163\195\181\195\177\195\156\195\139\195\188\195\171]"))
end
...
function MenuItemTextBox:scroll_to_line(row_item, line, direction)
	...
	if not direction then
		if scroll_pos_abs > line * row_item.gui_text:line_height() then
			direction = "up"
		else
			direction = "down"
		end
