function BlackMarketTweakData:_init_weapon_skins()
	...
	self.weapon_skins.famas_bloodsplat.types = {
		sight = {
			base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_004_df")
		}
	}
	...
	self.weapon_skins.mateba_wac.reserve_quality = true
	self.weapon_skins.mateba_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.mateba_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_df")
	self.weapon_skins.mateba_wac.parts = {
		wpn_fps_pis_2006m_g_bling = {
			[Idstring("mtr_grip"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/cola/base_gradient/base_cola_003_df"),
	...
	self.weapon_skins.mateba_wac.types = {
		barrel = {
			uv_offset_rot = Vector3(-0.0299578, 0.826616, 0),
			uv_scale = Vector3(3.40921, 4.26735, 0.220129)
		},
		magazine = {
			base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_b_df")
		}
	}
	...
	self.weapon_skins.c96_wac.reserve_quality = true
	self.weapon_skins.c96_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.c96_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_006_df")
	self.weapon_skins.c96_wac.sticker = Idstring("units/payday2_cash/safes/wac/sticker/wac_sticker_027_df")
	self.weapon_skins.c96_wac.uv_scale = Vector3(12.8488, 11.8953, 1)
	self.weapon_skins.c96_wac.uv_offset_rot = Vector3(0.0558996, 0.829076, 0)
	self.weapon_skins.c96_wac.parts = {
	...
	self.weapon_skins.c96_wac.types = {
		slide = {
	...
	self.weapon_skins.ksg_wac.reserve_quality = true
	self.weapon_skins.ksg_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.ksg_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_003_df")
	self.weapon_skins.ksg_wac.pattern_tweak = Vector3(4.06869, 0, 1)
	self.weapon_skins.ksg_wac.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_df")
			}
	...
	self.weapon_skins.glock_18c_wac.reserve_quality = true
	self.weapon_skins.glock_18c_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.glock_18c_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_004_df")
	self.weapon_skins.glock_18c_wac.parts = {
		wpn_fps_pis_g18c_m_mag_33rnd = {
			[Idstring("mtr_mag_extended"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/bah/base_gradient/base_bah_006_df")
			}
	...
	self.weapon_skins.aa12_wac.reserve_quality = true
	self.weapon_skins.aa12_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.aa12_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_008_df")
	self.weapon_skins.aa12_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_001_df")
	self.weapon_skins.aa12_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.aa12_wac.pattern_tweak = Vector3(5.45195, 0, 1)
	self.weapon_skins.aa12_wac.parts = {
		...
		wpn_fps_upg_o_acog = {
			[Idstring("mtr_acog"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_001_c_df")
			}
		},
		wpn_fps_upg_o_reflex = {
			[Idstring("reflex"):key()] = {
	...
	self.weapon_skins.aa12_wac.types = {
		barrel_ext = {
			base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_006_df"),
			pattern_tweak = Vector3(0, 0, 1)
		},
	...
	self.weapon_skins.galil_wac.reserve_quality = true
	self.weapon_skins.galil_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.galil_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_018_df")
	self.weapon_skins.galil_wac.pattern_gradient = Idstring("units/payday2_cash/safes/cop/pattern_gradient/gradient_cop_004_df")
	self.weapon_skins.galil_wac.pattern = Idstring("units/payday2_cash/safes/grunt/pattern/grunt_pattern_006_df")
	self.weapon_skins.galil_wac.pattern_tweak = Vector3(1.96995, 0, 1)
	self.weapon_skins.galil_wac.parts = {
		wpn_fps_upg_o_specter = {
			[Idstring("mtr_specter"):key()] = {
		...
		wpn_fps_ass_galil_g_standard = {
			[Idstring("mtr_grip"):key()] = {
				uv_offset_rot = Vector3(0, 0, 4.70977)
			}
		},
		wpn_fps_upg_ass_ns_battle = {
			[Idstring("mtr_battle"):key()] = {
	...
	self.weapon_skins.galil_wac.types = {
		barrel_ext = {
			base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_006_df")
		}
	}
	...
	self.weapon_skins.spas12_wac.reserve_quality = true
	self.weapon_skins.spas12_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.spas12_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_005_df")
	self.weapon_skins.spas12_wac.pattern_tweak = Vector3(4.54567, 0, 1)
	self.weapon_skins.spas12_wac.cubemap_pattern_control = Vector3(0.00787038, 0, 0)
	self.weapon_skins.spas12_wac.parts = {
		wpn_fps_sho_body_spas12_standard = {
			[Idstring("mtr_body"):key()] = {
	...
	self.weapon_skins.mp9_wac.reserve_quality = true
	self.weapon_skins.mp9_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.mp9_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_009_df")
	self.weapon_skins.mp9_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_005_df")
	self.weapon_skins.mp9_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.mp9_wac.pattern_tweak = Vector3(2.68543, 0, 1)
	self.weapon_skins.mp9_wac.parts = {
		wpn_fps_upg_fl_ass_smg_sho_peqbox = {
			[Idstring("mtr_peqbox"):key()] = {
				pattern_tweak = Vector3(0, 0, 1),
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_007_df")
	...
	self.weapon_skins.mp9_wac.types = {
		sight = {
			base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_004_df"),
			pattern_tweak = Vector3(0, 0, 1)
		},
	...
	self.weapon_skins.amcar_wac.reserve_quality = true
	self.weapon_skins.amcar_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.amcar_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_007_df")
	self.weapon_skins.amcar_wac.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_df"),
				sticker = Idstring("units/payday2_cash/safes/wac/sticker/wac_sticker_012_df"),
	...
	self.weapon_skins.amcar_wac.types = {
		lower_reciever = {
			base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_007_b_df"),
			pattern_tweak = Vector3(2.78083, 0, 1),
	...
	self.weapon_skins.desertfox_wac.reserve_quality = true
	self.weapon_skins.desertfox_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.desertfox_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_010_df")
	self.weapon_skins.desertfox_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_001_df")
	self.weapon_skins.desertfox_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.desertfox_wac.pattern_tweak = Vector3(4.45028, 0, 1)
	self.weapon_skins.desertfox_wac.parts = {
	...
	self.weapon_skins.desertfox_wac.types = {
		gadget = {
			pattern_tweak = Vector3(0, 0, 1)
		}
	}
	...
	self.weapon_skins.vhs_wac.reserve_quality = true
	self.weapon_skins.vhs_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.vhs_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_011_df")
	self.weapon_skins.vhs_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_001_df")
	self.weapon_skins.vhs_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.vhs_wac.pattern_tweak = Vector3(5.54734, 0, 1)
	self.weapon_skins.vhs_wac.default_blueprint = {
	...
	self.weapon_skins.vhs_wac.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_df"),
				pattern_tweak = Vector3(0, 0, 1)
		...
		wpn_fps_upg_o_spot = {
			[Idstring("mtr_spot"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_003_b_df")
			}
		},
		wpn_fps_upg_o_reflex = {
			[Idstring("reflex"):key()] = {
	...
	self.weapon_skins.vhs_wac.types = {
		sight = {
			base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_001_b_df")
		},
		barrel = {
	...
	self.weapon_skins.mp7_wac.reserve_quality = true
	self.weapon_skins.mp7_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.mp7_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_012_df")
	self.weapon_skins.mp7_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_005_df")
	self.weapon_skins.mp7_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.mp7_wac.pattern_tweak = Vector3(2.35154, 0, 1)
	self.weapon_skins.mp7_wac.default_blueprint = {
	...
	self.weapon_skins.mp7_wac.parts = {
		wpn_fps_upg_ns_ass_smg_medium = {
			[Idstring("medium"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_002_b_df")
			}
		...
		wpn_fps_smg_mp7_body_standard = {
			...
			[Idstring("mtr_charging_handle"):key()] = {
				pattern_tweak = Vector3(1.11138, 0, 1)
			},
			[Idstring("mtr_sights"):key()] = {
	...
	self.weapon_skins.mp7_wac.types = {
		upper_reciever = {
	...
	self.weapon_skins.g26_wac.reserve_quality = true
	self.weapon_skins.g26_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.g26_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_013_df")
	self.weapon_skins.g26_wac.pattern_tweak = Vector3(1.01598, 0, 1)
	self.weapon_skins.g26_wac.default_blueprint = {
		"wpn_fps_pis_g26_g_gripforce",
	...
	self.weapon_skins.g26_wac.parts = {
		wpn_fps_pis_g18c_m_mag_33rnd = {
			[Idstring("mtr_mag_extended"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/burn/base_gradient/base_burn_015_df"),
		...
		wpn_fps_pis_g26_b_standard = {
			[Idstring("mtr_slide"):key()] = {
				sticker = Idstring("units/payday2_cash/safes/wac/sticker/wac_sticker_031_df")
			}
		},
		wpn_fps_upg_ns_pis_jungle = {
			[Idstring("mtr_jungle"):key()] = {
	...
	self.weapon_skins.g26_wac.types = {
		slide = {
	...
	self.weapon_skins.x_mp5_wac.weapon_id = "x_mp5"
	self.weapon_skins.x_mp5_wac.rarity = "epic"
	self.weapon_skins.x_mp5_wac.bonus = "recoil_p1"
	self.weapon_skins.x_mp5_wac.reserve_quality = true
	self.weapon_skins.x_mp5_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.x_mp5_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_016_df")
	self.weapon_skins.x_mp5_wac.pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_005_df")
	self.weapon_skins.x_mp5_wac.pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_001_df")
	self.weapon_skins.x_mp5_wac.pattern_tweak = Vector3(2.92392, 0, 1)
	self.weapon_skins.x_mp5_wac.pattern_pos = Vector3(0.01, 0.445028, 0)
	self.weapon_skins.x_mp5_wac.default_blueprint = {
		"wpn_fps_smg_mp5_body_mp5",
		"wpn_fps_smg_mp5_m_std",
		"wpn_fps_smg_mp5_s_ring_vanilla",
		"wpn_fps_smg_mp5_fg_mp5a5",
	...
	self.weapon_skins.x_mp5_wac.parts = {
		wpn_fps_smg_mp5_fg_mp5a5 = {
			[Idstring("mp5a5"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_016_b_df")
			}
		},
		wpn_fps_smg_mp5_fg_mp5sd = {
			[Idstring("mtr_sd"):key()] = {
		...
		wpn_fps_smg_mp5_m_straight = {
			[Idstring("mtr_straight"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_008_b_df"),
				pattern_tweak = Vector3(0, 0, 1)
			}
		}
	}
	self.weapon_skins.x_mp5_wac.types = {
		foregrip = {
	...
	self.weapon_skins.msr_wac.reserve_quality = true
	self.weapon_skins.msr_wac.texture_bundle_folder = "cash/safes/wac"
	self.weapon_skins.msr_wac.base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_015_df")
	self.weapon_skins.msr_wac.pattern_tweak = Vector3(17.3289, 0, 1)
	self.weapon_skins.msr_wac.uv_scale = Vector3(1, 1, 0)
	self.weapon_skins.msr_wac.default_blueprint = {
	...
	self.weapon_skins.msr_wac.parts = {
		wpn_fps_upg_o_leupold = {
			[Idstring("leupold"):key()] = {
	...
	self.weapon_skins.msr_wac.types = {
		stock = {
			pattern_gradient = Idstring("units/payday2_cash/safes/wac/pattern_gradient/gradient_wac_002_df"),
			pattern = Idstring("units/payday2_cash/safes/wac/pattern/wac_pattern_002_df")
		}
	...
	self.weapon_skins.x_akmsu_wac.name_id = "bm_wskn_x_akmsu_wac"
	self.weapon_skins.x_akmsu_wac.desc_id = "bm_wskn_x_akmsu_wac_desc"
	self.weapon_skins.x_akmsu_wac.weapon_id = "x_akmsu"
	self.weapon_skins.x_akmsu_wac.rarity = "legendary"
	self.weapon_skins.x_akmsu_wac.bonus = "recoil_p1"
	...
	self.weapon_skins.x_akmsu_wac.pattern_tweak = Vector3(0.72979, 0, 1)
	self.weapon_skins.x_akmsu_wac.pattern_pos = Vector3(-0.766515, -0.327689, 0)
	...
	self.weapon_skins.x_akmsu_wac.parts = {
		wpn_fps_smg_akmsu_fg_standard = {
			[Idstring("akmsu_handguard"):key()] = {
	...
	self.weapon_skins.x_akmsu_wac.types = {
		foregrip = {
	...
	self.weapon_skins.judge_cs3.reserve_quality = true
	self.weapon_skins.judge_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.judge_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_001_df"
	self.weapon_skins.judge_cs3.parts = {
		wpn_fps_pis_judge_body_standard = {
			[Idstring("mtr_cylinder"):key()] = {
	...
	self.weapon_skins.judge_cs3.types = {
		lower_reciever = {
	...
	self.weapon_skins.polymer_cs3.reserve_quality = true
	self.weapon_skins.polymer_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.polymer_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_002_c_df"
	self.weapon_skins.polymer_cs3.parts = {
		wpn_fps_smg_polymer_fg_standard = {
			[Idstring("mtr_fg"):key()] = {
		...
		wpn_fps_upg_o_acog = {
			[Idstring("mtr_acog"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_002_e_df"
			}
		},
		wpn_fps_smg_polymer_s_standard = {
			[Idstring("mtr_stock"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_002_df"
			}
		},
		wpn_fps_smg_polymer_body_standard = {
			[Idstring("mtr_body"):key()] = {
		...
		wpn_fps_upg_o_cs = {
			[Idstring("mtr_cs"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_002_b_df"
			}
		},
		wpn_fps_upg_fl_ass_peq15 = {
			[Idstring("mtr_peq15"):key()] = {
	...
	self.weapon_skins.polymer_cs3.types = {
		stock = {
			base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_002_b_df"
		},
		barrel_ext = {
	...
	self.weapon_skins.arbiter_cs3.reserve_quality = true
	self.weapon_skins.arbiter_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.arbiter_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_005_df"
	self.weapon_skins.arbiter_cs3.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
	...
	self.weapon_skins.aa12_cs3.reserve_quality = true
	self.weapon_skins.aa12_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.aa12_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_006_df"
	self.weapon_skins.aa12_cs3.parts = {
		wpn_fps_sho_aa12_barrel_silenced = {
			[Idstring("aa12_silencer"):key()] = {
		...
		wpn_fps_upg_ns_shot_thick = {
			[Idstring("thick"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/wac/base_gradient/base_wac_000_df")
			}
		},
		wpn_fps_upg_o_cmore = {
			[Idstring("cmore"):key()] = {
		...
		wpn_fps_sho_aa12_mag_drum = {
			...
			[Idstring("slug_slug"):key()] = {
				pattern = "units/payday2_cash/safes/cs3/pattern/cs3_pattern_003_df"
			}
		}
	}
	self.weapon_skins.aa12_cs3.types = {
		lower_reciever = {
			pattern_gradient = "units/payday2_cash/safes/cs3/pattern_gradient/gradient_cs3_003_df",
	...
	self.weapon_skins.saw_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.saw_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_008_b_df"
	self.weapon_skins.saw_cs3.parts = {
		wpn_fps_saw_body_speed = {
			[Idstring("mtr_fast_motor"):key()] = {},
			[Idstring("mtr_saw"):key()] = {
	...
	self.weapon_skins.saw_cs3.types = {
		lower_reciever = {
			pattern_gradient = "units/payday2_cash/safes/cs3/pattern_gradient/gradient_cs3_005_df"
		}
	}
	...
	self.weapon_skins.m95_cs3.reserve_quality = true
	self.weapon_skins.m95_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.m95_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_021_df"
	self.weapon_skins.m95_cs3.parts = {
		wpn_fps_snp_m95_barrel_long = {
			[Idstring("mtr_long"):key()] = {
				uv_offset_rot = Vector3(-2, -2, 0),
				uv_scale = Vector3(20, 20, 1)
			}
		},
		...
		wpn_fps_snp_m95_upper_reciever = {
			[Idstring("mtr_upper"):key()] = {
				...
				uv_offset_rot = Vector3(5.02503E-4, 1.03649, 0),
	...
	self.weapon_skins.m95_cs3.types = {
		barrel = {
	...
	self.weapon_skins.sparrow_cs3.reserve_quality = true
	self.weapon_skins.sparrow_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.sparrow_cs3.default_blueprint = {
		"wpn_fps_pis_sparrow_m_standard",
		"wpn_fps_pis_sparrow_sl_rpl",
		"wpn_fps_pis_sparrow_body_941",
		"wpn_fps_pis_sparrow_b_threaded",
	...
	self.weapon_skins.sparrow_cs3.parts = {
		wpn_fps_upg_ns_pis_ipsccomp = {
			[Idstring("mtr_comp"):key()] = {
	...
	self.weapon_skins.tti_cs3.reserve_quality = true
	self.weapon_skins.tti_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.tti_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_012_df"
	self.weapon_skins.tti_cs3.default_blueprint = {
	...
	self.weapon_skins.tti_cs3.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
	...
	self.weapon_skins.new_raging_bull_cs3.reserve_quality = true
	self.weapon_skins.new_raging_bull_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.new_raging_bull_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_013_df"
	self.weapon_skins.new_raging_bull_cs3.default_blueprint = {
		"wpn_fps_pis_rage_body_standard",
		"wpn_fps_pis_rage_b_long",
		"wpn_fps_pis_rage_extra",
		"wpn_fps_pis_rage_g_standard"
	}
	self.weapon_skins.new_raging_bull_cs3.parts = {
		wpn_fps_pis_rage_g_ergo = {
			[Idstring("ergo"):key()] = {
		...
		wpn_fps_pis_rage_b_comp2 = {
			[Idstring("comp2"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_013_df",
				pattern_pos = Vector3(5.02519E-4, 0, 0),
				pattern = "units/payday2_cash/safes/cs3/pattern/cs3_pattern_009_b_df"
			}
		},
		wpn_fps_pis_rage_body_smooth = {
	...
	self.weapon_skins.ppk_cs3.name_id = "bm_wskn_ppk_cs3"
	self.weapon_skins.ppk_cs3.desc_id = "bm_wskn_ppk_cs3_desc"
	self.weapon_skins.ppk_cs3.weapon_id = "ppk"
	self.weapon_skins.ppk_cs3.rarity = "legendary"
	self.weapon_skins.ppk_cs3.bonus = "spread_p1"
	...
	self.weapon_skins.ppk_cs3.parts = {
		wpn_fps_upg_ns_pis_medium = {
			[Idstring("medium"):key()] = {
	...
	self.weapon_skins.ppk_cs3.types = {
		grip = {
	...
	self.weapon_skins.new_mp5_cs3.reserve_quality = true
	self.weapon_skins.new_mp5_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.new_mp5_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_015_df"
	self.weapon_skins.new_mp5_cs3.parts = {
		wpn_fps_upg_o_rx01 = {
			[Idstring("rx01"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_015_b_df"
			}
		},
		wpn_fps_upg_o_eotech = {
			[Idstring("mtr_eotech"):key()] = {
	...
	self.weapon_skins.new_mp5_cs3.types = {
		gadget = {
			cubemap_pattern_control = Vector3(0, 1, 0)
		},
		sight = {
	...
	self.weapon_skins.frankish_cs3.reserve_quality = true
	self.weapon_skins.frankish_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.frankish_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_016_df"
	self.weapon_skins.frankish_cs3.parts = {
		wpn_fps_bow_frankish_b_steel = {
			[Idstring("M_Weapon_Master"):key()] = {
	...
	self.weapon_skins.huntsman_cs3.reserve_quality = true
	self.weapon_skins.huntsman_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.huntsman_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_018_df"
	self.weapon_skins.huntsman_cs3.cubemap_pattern_control = Vector3(0.001, 7.15595E-4, 0)
	self.weapon_skins.huntsman_cs3.default_blueprint = {
		"wpn_fps_shot_huntsman_body_standard",
		"wpn_fps_shot_huntsman_b_long",
		"wpn_fps_shot_huntsman_s_short"
	}
	self.weapon_skins.huntsman_cs3.parts = {
		wpn_fps_shot_huntsman_s_long = {
			[Idstring("long_stock"):key()] = {
	...
	self.weapon_skins.huntsman_cs3.types = {
		stock = {
			base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_018_c_df"
		},
		barrel = {
	...
	self.weapon_skins.flint_cs3.reserve_quality = true
	self.weapon_skins.flint_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.flint_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_019_df"
	self.weapon_skins.flint_cs3.parts = {
		wpn_fps_ass_flint_b_standard = {
			[Idstring("mat_barrel"):key()] = {
	...
	self.weapon_skins.flint_cs3.types = {
		stock = {
			pattern_gradient = "units/payday2_cash/safes/cs3/pattern_gradient/gradient_cs3_015_df",
			pattern_tweak = Vector3(1, 1.42807, 0),
			pattern = "units/payday2_cash/safes/cs3/pattern/cs3_pattern_015_b_df"
	...
	self.weapon_skins.peacemaker_cs3.reserve_quality = true
	self.weapon_skins.peacemaker_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.peacemaker_cs3.base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_020_df"
	self.weapon_skins.peacemaker_cs3.parts = {
	...
	self.weapon_skins.new_m4_cs3.reserve_quality = true
	self.weapon_skins.new_m4_cs3.texture_bundle_folder = "cash/safes/cs3"
	self.weapon_skins.new_m4_cs3.base_gradient = Idstring("units/payday2_cash/safes/cs3/base_gradient/base_cs3_022_df")
	self.weapon_skins.new_m4_cs3.default_blueprint = {
	...
	self.weapon_skins.new_m4_cs3.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
		...
		wpn_fps_m4_uupg_draghandle = {
			...
			[Idstring("m4_draghandle"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_022_c_df"
			},
			[Idstring("mtr_raptor"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_022_c_df"
			}
		},
		wpn_fps_upg_fl_ass_utg = {
	...
	self.weapon_skins.new_m4_cs3.types = {
		barrel_ext = {
			base_gradient = "units/payday2_cash/safes/cs3/base_gradient/base_cs3_022_b_df"
		},
		grip = {
	...
	self.weapon_skins.tec9_mxs.reserve_quality = true
	self.weapon_skins.tec9_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.tec9_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df")
	self.weapon_skins.tec9_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_001_df")
	self.weapon_skins.tec9_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_001_df")
	self.weapon_skins.tec9_mxs.pattern_tweak = Vector3(3.6394, 0, 1)
	self.weapon_skins.tec9_mxs.parts = {
		wpn_fps_upg_o_cmore = {
			[Idstring("cmore"):key()] = {
				pattern_tweak = Vector3(1.15908, 0, 1)
			}
	...
	self.weapon_skins.tec9_mxs.types = {
		gadget = {
			pattern_tweak = Vector3(0, 0, 1),
	...
	self.weapon_skins.siltstone_mxs.reserve_quality = true
	self.weapon_skins.siltstone_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.siltstone_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_002_df")
	self.weapon_skins.siltstone_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/shared/pattern_gradient/gradient_shared_002_df")
	self.weapon_skins.siltstone_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_004_df")
	self.weapon_skins.siltstone_mxs.pattern_tweak = Vector3(0.968283, 0, 1)
	self.weapon_skins.siltstone_mxs.pattern_pos = Vector3(0, -0.0224181, 0)
	self.weapon_skins.siltstone_mxs.cubemap_pattern_control = Vector3(0, 0.001, 0)
	self.weapon_skins.siltstone_mxs.parts = {
		wpn_fps_upg_o_box = {
			[Idstring("mtr_box"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_005_df")
			}
	...
	self.weapon_skins.siltstone_mxs.types = {
		sight = {
	...
	self.weapon_skins.contraband_mxs.reserve_quality = true
	self.weapon_skins.contraband_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.contraband_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_003_b_df")
	self.weapon_skins.contraband_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/bah/pattern_gradient/gradient_bah_002_df")
	self.weapon_skins.contraband_mxs.pattern_pos = Vector3(-0.348308, 0.0920584, 0)
	self.weapon_skins.contraband_mxs.uv_offset_rot = Vector3(-0.001, 0, 0)
	self.weapon_skins.contraband_mxs.parts = {
		wpn_fps_ass_contraband_body_standard = {
			[Idstring("mtr_upper"):key()] = {
	...
	self.weapon_skins.contraband_mxs.types = {
		magazine = {
			pattern_tweak = Vector3(0, 0, 1)
		}
	}
	...
	self.weapon_skins.lemming_mxs.reserve_quality = true
	self.weapon_skins.lemming_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.lemming_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_004_df")
	self.weapon_skins.lemming_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_004_df")
	self.weapon_skins.lemming_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_006_df")
	self.weapon_skins.lemming_mxs.pattern_tweak = Vector3(1.11138, 0.00449621, 0.606487)
	self.weapon_skins.lemming_mxs.pattern_pos = Vector3(1.20859, 0.392789, 0)
	self.weapon_skins.lemming_mxs.parts = {
		wpn_fps_upg_fl_pis_x400v = {
			[Idstring("mtr_x400v"):key()] = {
				pattern_tweak = Vector3(0, 0, 1),
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df"),
	...
	self.weapon_skins.china_mxs.reserve_quality = true
	self.weapon_skins.china_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.china_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_006_df")
	self.weapon_skins.china_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_005_df")
	self.weapon_skins.china_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_006_df")
	self.weapon_skins.china_mxs.pattern_tweak = Vector3(3.5917, 0, 1)
	self.weapon_skins.china_mxs.parts = {
		wpn_fps_gre_china_body_standard = {
			[Idstring("mtr_upper"):key()] = {
	...
	self.weapon_skins.rota_mxs.reserve_quality = true
	self.weapon_skins.rota_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.rota_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_007_df")
	self.weapon_skins.rota_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/shared/pattern_gradient/pattern_gradient_camo_snow_001_df")
	self.weapon_skins.rota_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_006_df")
	self.weapon_skins.rota_mxs.pattern_tweak = Vector3(1.15908, 0, 1)
	self.weapon_skins.rota_mxs.pattern_pos = Vector3(0, 0.349631, 0)
	self.weapon_skins.rota_mxs.parts = {
		wpn_fps_upg_fl_ass_smg_sho_surefire = {
			[Idstring("surefire"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_003_df")
			}
		},
		wpn_fps_upg_ns_shot_thick = {
			[Idstring("thick"):key()] = {
	...
	self.weapon_skins.x_deagle_mxs.weapon_id = "x_deagle"
	self.weapon_skins.x_deagle_mxs.rarity = "common"
	self.weapon_skins.x_deagle_mxs.bonus = "recoil_p1"
	self.weapon_skins.x_deagle_mxs.reserve_quality = true
	self.weapon_skins.x_deagle_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.x_deagle_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_008_b_df")
	self.weapon_skins.x_deagle_mxs.parts = {
		wpn_fps_pis_deagle_g_standard = {
			[Idstring("grip"):key()] = {
				pattern_pos = Vector3(0, 0.006, 0)
			}
	...
	self.weapon_skins.x_deagle_mxs.types = {
		lower_reciever = {
			base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_015_df")
		},
		grip = {
	...
	self.weapon_skins.scar_mxs.reserve_quality = true
	self.weapon_skins.scar_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.scar_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df")
	self.weapon_skins.scar_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/bah/pattern_gradient/gradient_bah_002_df")
	self.weapon_skins.scar_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_002_df")
	self.weapon_skins.scar_mxs.pattern_tweak = Vector3(2.01765, 0, 1)
	self.weapon_skins.scar_mxs.pattern_pos = Vector3(0, 0.0538996, 0)
	self.weapon_skins.scar_mxs.uv_offset_rot = Vector3(0.855235, 0.778917, 0)
	self.weapon_skins.scar_mxs.cubemap_pattern_control = Vector3(1, 1, 0)
	self.weapon_skins.scar_mxs.parts = {
		wpn_fps_upg_vg_ass_smg_afg = {
			[Idstring("afg"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_003_df")
			}
	...
	self.weapon_skins.chinchilla_mxs.reserve_quality = true
	self.weapon_skins.chinchilla_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.chinchilla_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_011_df")
	self.weapon_skins.chinchilla_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_006_df")
	self.weapon_skins.chinchilla_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_002_df")
	self.weapon_skins.chinchilla_mxs.uv_offset_rot = Vector3(0, 0.464107, 0)
	self.weapon_skins.chinchilla_mxs.default_blueprint = {
	...
	self.weapon_skins.chinchilla_mxs.parts = {
		wpn_fps_pis_chinchilla_ejector = {
			[Idstring("base"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_b_df"),
				pattern_tweak = Vector3(0, 0, 1),
	...
	self.weapon_skins.x_chinchilla_mxs.name_id = "bm_wskn_x_chinchilla_mxs"
	self.weapon_skins.x_chinchilla_mxs.desc_id = "bm_wskn_x_chinchilla_mxs_desc"
	self.weapon_skins.x_chinchilla_mxs.weapon_id = "x_chinchilla"
	self.weapon_skins.x_chinchilla_mxs.rarity = "legendary"
	self.weapon_skins.x_chinchilla_mxs.bonus = "recoil_p1"
	...
	self.weapon_skins.x_chinchilla_mxs.pattern_tweak = Vector3(2.59003, 0, 1)
	...
	self.weapon_skins.x_chinchilla_mxs.parts = {
		wpn_fps_pis_chinchilla_g_black = {
			[Idstring("grip_black"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_006_df"),
		...
		wpn_fps_pis_chinchilla_dh_hammer = {
			[Idstring("base"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_013_c_df")
			}
		},
	...
	self.weapon_skins.x_chinchilla_mxs.types = {
		grip = {
			base_gradient = Idstring("units/payday2_cash/safes/buck/base_gradient/base_buck_001_df"),
			pattern_tweak = Vector3(0, 0, 1),
			pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_008_df")
	...
	self.weapon_skins.jowi_mxs.weapon_id = "jowi"
	self.weapon_skins.jowi_mxs.rarity = "rare"
	self.weapon_skins.jowi_mxs.bonus = "recoil_p1"
	self.weapon_skins.jowi_mxs.reserve_quality = true
	self.weapon_skins.jowi_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.jowi_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_009_df")
	self.weapon_skins.jowi_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_006_df")
	self.weapon_skins.jowi_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_002_df")
	self.weapon_skins.jowi_mxs.default_blueprint = {
		"wpn_fps_pis_g26_body_custom",
		"wpn_fps_pis_g26_b_custom",
		"wpn_fps_pis_g26_m_contour",
		"wpn_fps_pis_g26_g_gripforce",
	...
	self.weapon_skins.jowi_mxs.parts = {
		wpn_fps_upg_ns_pis_ipsccomp = {
			[Idstring("mtr_comp"):key()] = {
				pattern_pos = Vector3(0, -0.0380372, 0)
			}
		},
		wpn_fps_upg_ns_ass_filter = {
			[Idstring("mtr_filter"):key()] = {
		...
		wpn_fps_pis_g26_b_custom = {
			[Idstring("mtr_slide"):key()] = {
				pattern_pos = Vector3(-0.149815, 0.072979, 0)
			}
		}
	}
	self.weapon_skins.jowi_mxs.types = {
		slide = {
			base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_009_b_df"),
	...
	self.weapon_skins.x_usp_mxs.weapon_id = "x_usp"
	self.weapon_skins.x_usp_mxs.rarity = "epic"
	self.weapon_skins.x_usp_mxs.bonus = "recoil_p1"
	self.weapon_skins.x_usp_mxs.reserve_quality = true
	self.weapon_skins.x_usp_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.x_usp_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_012_df")
	self.weapon_skins.x_usp_mxs.default_blueprint = {
	...
	self.weapon_skins.x_usp_mxs.parts = {
		wpn_fps_pis_usp_b_match = {
	...
	self.weapon_skins.x_usp_mxs.types = {
		slide = {
			pattern_pos = Vector3(0, 0.005, 0),
	...
	self.weapon_skins.par_mxs.reserve_quality = true
	self.weapon_skins.par_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.par_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_006_df")
	self.weapon_skins.par_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_004_df")
	self.weapon_skins.par_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_006_df")
	self.weapon_skins.par_mxs.pattern_tweak = Vector3(8.17076, 0, 1)
	self.weapon_skins.par_mxs.parts = {
		wpn_fps_lmg_par_body_standard = {
			[Idstring("mtr_sight"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df")
			},
	...
	self.weapon_skins.par_mxs.types = {
		stock = {
			base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_010_b_df"),
	...
	self.weapon_skins.akm_mxs.reserve_quality = true
	self.weapon_skins.akm_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.akm_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_013_df")
	self.weapon_skins.akm_mxs.default_blueprint = {
		"wpn_fps_ass_akm_body_upperreceiver_vanilla",
		"wpn_fps_ass_ak_body_lowerreceiver",
		"wpn_fps_upg_ak_m_uspalm",
		"wpn_fps_upg_fl_ass_utg",
	...
	self.weapon_skins.akm_mxs.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_010_df")
			}
		...
		wpn_fps_upg_ak_m_quick = {
			[Idstring("mtr_magpul"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_008_df")
			}
		},
		wpn_fps_upg_o_acog = {
			[Idstring("mtr_acog"):key()] = {
	...
	self.weapon_skins.akm_mxs.types = {
		stock = {
			base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_010_b_df"),
	...
	self.weapon_skins.striker_mxs.reserve_quality = true
	self.weapon_skins.striker_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.striker_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df")
	self.weapon_skins.striker_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_004_df")
	self.weapon_skins.striker_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_006_df")
	self.weapon_skins.striker_mxs.pattern_tweak = Vector3(3.35321, 0, 1)
	self.weapon_skins.striker_mxs.parts = {
		wpn_fps_sho_striker_body_standard = {
			[Idstring("mtr_body"):key()] = {
				sticker = Idstring("units/payday2_cash/safes/mxs/sticker/mxs_sticker_002_df"),
	...
	self.weapon_skins.amcar_mxs.reserve_quality = true
	self.weapon_skins.amcar_mxs.texture_bundle_folder = "cash/safes/mxs"
	self.weapon_skins.amcar_mxs.base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_015_df")
	self.weapon_skins.amcar_mxs.pattern_gradient = Idstring("units/payday2_cash/safes/mxs/pattern_gradient/gradient_mxs_009_df")
	self.weapon_skins.amcar_mxs.pattern = Idstring("units/payday2_cash/safes/mxs/pattern/mxs_pattern_003_df")
	self.weapon_skins.amcar_mxs.pattern_tweak = Vector3(1.20678, 0, 1)
	self.weapon_skins.amcar_mxs.pattern_pos = Vector3(0, -0.165514, 0)
	self.weapon_skins.amcar_mxs.default_blueprint = {
		"wpn_fps_m4_uupg_b_medium_vanilla",
		"wpn_fps_m4_lower_reciever",
		"wpn_fps_amcar_uupg_fg_amcar",
		"wpn_fps_upg_m4_g_standard_vanilla",
	...
	self.weapon_skins.amcar_mxs.parts = {
		wpn_fps_upg_o_rx01 = {
			[Idstring("rx01"):key()] = {
				base_gradient = Idstring("units/payday2_cash/safes/mxs/base_gradient/base_mxs_001_df")
			}
		...
		wpn_fps_upg_ns_ass_smg_stubby = {
			[Idstring("stubby"):key()] = {
				pattern_tweak = Vector3(0.635393, 0, 1)
			}
		},
	...
	self.weapon_skins.polymer_cs4.reserve_quality = true
	self.weapon_skins.polymer_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.polymer_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_001_df"
	self.weapon_skins.polymer_cs4.parts = {
		wpn_fps_smg_polymer_body_standard = {
			[Idstring("mtr_body"):key()] = {
	...
	self.weapon_skins.l85a2_cs4.reserve_quality = true
	self.weapon_skins.l85a2_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.l85a2_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_002_b_df"
	self.weapon_skins.l85a2_cs4.default_blueprint = {
	...
	self.weapon_skins.l85a2_cs4.parts = {
		wpn_fps_ass_l85a2_body_standard = {
			[Idstring("mtr_body"):key()] = {
	...
	self.weapon_skins.amcar_cs4.reserve_quality = true
	self.weapon_skins.amcar_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.amcar_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_003_df"
	self.weapon_skins.amcar_cs4.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
	...
	self.weapon_skins.amcar_cs4.types = {
		barrel_ext = {
	...
	self.weapon_skins.usp_cs4.reserve_quality = true
	self.weapon_skins.usp_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.usp_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_004_df"
	self.weapon_skins.usp_cs4.parts = {
		wpn_fps_upg_ns_pis_jungle = {
			[Idstring("mtr_jungle"):key()] = {
	...
	self.weapon_skins.usp_cs4.types = {
		barrel_ext = {
			cubemap_pattern_control = Vector3(0, 0.001, 0)
		}
	}
	...
	self.weapon_skins.m16_cs4.reserve_quality = true
	self.weapon_skins.m16_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.m16_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_005_b_df"
	self.weapon_skins.m16_cs4.pattern_gradient = "units/payday2_cash/safes/cs4/pattern_gradient/gradient_cs4_005_df"
	self.weapon_skins.m16_cs4.pattern = "units/payday2_cash/safes/cs4/pattern/cs4_pattern_005_df"
	self.weapon_skins.m16_cs4.pattern_tweak = Vector3(0.872886, 0.184315, 1)
	self.weapon_skins.m16_cs4.pattern_pos = Vector3(-2, -2, 0)
	...
	self.weapon_skins.m16_cs4.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
				pattern_tweak = Vector3(1.44527, 0, 1),
	...
	self.weapon_skins.m16_cs4.types = {
		foregrip = {
	...
	self.weapon_skins.benelli_cs4.reserve_quality = true
	self.weapon_skins.benelli_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.benelli_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_006_df"
	self.weapon_skins.benelli_cs4.pattern_gradient = Idstring("units/payday2_cash/safes/bah/pattern_gradient/gradient_bah_002_df")
	...
	self.weapon_skins.wa2000_cs4.reserve_quality = true
	self.weapon_skins.wa2000_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.wa2000_cs4.base_gradient = Idstring("units/payday2_cash/safes/cs4/base_gradient/base_cs4_007_df")
	self.weapon_skins.wa2000_cs4.parts = {
	...
	self.weapon_skins.serbu_cs4.reserve_quality = true
	self.weapon_skins.serbu_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.serbu_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_008_df"
	self.weapon_skins.serbu_cs4.default_blueprint = {
		"wpn_fps_shot_r870_body_standard",
		"wpn_fps_shot_r870_b_short",
		"wpn_fps_shot_r870_fg_small",
	...
	self.weapon_skins.serbu_cs4.parts = {
		wpn_fps_upg_m4_s_mk46 = {
			[Idstring("mtr_crane_mk46"):key()] = {
	...
	self.weapon_skins.serbu_cs4.types = {
		gadget = {
			base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_008_b_df",
	...
	self.weapon_skins.arbiter_cs4.reserve_quality = true
	self.weapon_skins.arbiter_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.arbiter_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_010_d_df"
	self.weapon_skins.arbiter_cs4.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
	...
	self.weapon_skins.chinchilla_cs4.reserve_quality = true
	self.weapon_skins.chinchilla_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.chinchilla_cs4.default_blueprint = {
		"wpn_fps_pis_chinchilla_body",
		"wpn_fps_pis_chinchilla_cylinder",
		"wpn_fps_pis_chinchilla_dh_hammer",
		"wpn_fps_pis_chinchilla_ejector",
	...
	self.weapon_skins.chinchilla_cs4.parts = {
		wpn_fps_pis_chinchilla_g_black = {
			[Idstring("grip_black"):key()] = {
		...
		wpn_fps_pis_chinchilla_b_satan = {
			[Idstring("barrel"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_011_b_df"
			},
			[Idstring("mtr_satan"):key()] = {
		...
		wpn_fps_pis_chinchilla_ejectorpin = {
			[Idstring("cylinder"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_011_df"
			}
		},
		wpn_fps_pis_chinchilla_g_death = {
			[Idstring("grip_black"):key()] = {
	...
	self.weapon_skins.chinchilla_cs4.types = {
		barrel = {}
	}
	...
	self.weapon_skins.flint_cs4.reserve_quality = true
	self.weapon_skins.flint_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.flint_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_012_b_df"
	self.weapon_skins.flint_cs4.default_blueprint = {
		"wpn_fps_ass_flint_b_standard",
		"wpn_fps_ass_flint_body_upperreceiver",
	...
	self.weapon_skins.flint_cs4.parts = {
		wpn_fps_upg_o_rx01 = {
			[Idstring("rx01"):key()] = {
	...
	self.weapon_skins.rpg7_cs4.reserve_quality = true
	self.weapon_skins.rpg7_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.rpg7_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_013_df"
	self.weapon_skins.rpg7_cs4.pattern_gradient = "units/payday2_cash/safes/cs4/pattern_gradient/gradient_cs4_013_df"
	self.weapon_skins.rpg7_cs4.parts = {
		wpn_fps_rpg7_m_rocket = {
			[Idstring("mtr_rocket"):key()] = {
				pattern = "units/payday2_cash/safes/cs4/pattern/cs4_pattern_013_b_df"
			}
		},
		wpn_fps_rpg7_sight = {
			[Idstring("mtr_sights"):key()] = {}
	...
	self.weapon_skins.striker_cs4.reserve_quality = true
	self.weapon_skins.striker_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.striker_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_014_df"
	self.weapon_skins.striker_cs4.pattern_gradient = "units/payday2_cash/safes/cs4/pattern_gradient/gradient_cs4_014_df"
	self.weapon_skins.striker_cs4.default_blueprint = {
		"wpn_fps_sho_striker_body_standard",
		"wpn_fps_sho_striker_b_standard",
		"wpn_fps_upg_o_aimpoint_2",
		"wpn_fps_upg_ns_shot_shark"
	}
	self.weapon_skins.striker_cs4.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
	...
	self.weapon_skins.striker_cs4.types = {
		gadget = {
			base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_014_b_df"
		},
		barrel_ext = {
	...
	self.weapon_skins.new_raging_bull_cs4.reserve_quality = true
	self.weapon_skins.new_raging_bull_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.new_raging_bull_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_015_df"
	self.weapon_skins.new_raging_bull_cs4.default_blueprint = {
		"wpn_fps_pis_rage_extra",
		"wpn_fps_pis_rage_b_long",
		"wpn_fps_pis_rage_g_ergo",
		"wpn_fps_pis_rage_body_standard"
	}
	self.weapon_skins.new_raging_bull_cs4.parts = {
		wpn_fps_upg_o_docter = {
			[Idstring("docter"):key()] = {
		...
		wpn_fps_upg_o_eotech = {
			[Idstring("mtr_eotech"):key()] = {
				base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_015_b_df"
			}
		},
		wpn_fps_pis_rage_g_ergo = {
			[Idstring("ergo"):key()] = {
	...
	self.weapon_skins.p90_cs4.name_id = "bm_wskn_p90_cs4"
	...
	self.weapon_skins.p90_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.p90_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_016_df"
	self.weapon_skins.p90_cs4.pattern_gradient = "units/payday2_cash/safes/cs4/pattern_gradient/gradient_cs4_016_df"
	self.weapon_skins.p90_cs4.pattern = "units/payday2_cash/safes/cs4/pattern/cs4_pattern_016_b_df"
	self.weapon_skins.p90_cs4.parts = {
		wpn_fps_smg_p90_body_p90 = {
			[Idstring("p90"):key()] = {
		...
		wpn_fps_smg_p90_b_long = {
			[Idstring("long"):key()] = {
				pattern = "units/payday2_cash/safes/cs4/pattern/cs4_pattern_016_df"
			}
		}
	}
	self.weapon_skins.p90_cs4.types = {
		foregrip = {},
		slide = {},
		barrel_ext = {
	...
	self.weapon_skins.mac10_cs4.reserve_quality = true
	self.weapon_skins.mac10_cs4.texture_bundle_folder = "cash/safes/cs4"
	self.weapon_skins.mac10_cs4.base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_019_df"
	self.weapon_skins.mac10_cs4.default_blueprint = {
		"wpn_fps_smg_mac10_body_mac10",
		"wpn_fps_smg_mac10_b_dummy",
		"wpn_fps_smg_mac10_m_short",
		"wpn_fps_smg_mac10_s_fold"
	}
	self.weapon_skins.mac10_cs4.types = {
		barrel_ext = {
		...
		magazine = {
			base_gradient = "units/payday2_cash/safes/cs4/base_gradient/base_cs4_019_b_df"
		}
	}
end
